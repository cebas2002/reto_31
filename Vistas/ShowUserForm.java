...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void recibeDatosUserMenu(int idEmp, String nombreEmp, String apellidos, String documento, String correo ){
    ...
    public void ActualizarEmpleado(){
        ...
        if (nombre.isEmpty()) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this,"Se han actualizado los datos.", "", JOptionPane.INFORMATION_MESSAGE);
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(this,"no se han actualizado los datos.", "", JOptionPane.WARNING_MESSAGE);
            }
            this.dispose();
        }
    }
    ...
    public void EliminarEmpleado(){
        ...
        try {
            ...
            st = connection.createStatement();
            st.executeUpdate(query);
            JOptionPane.showMessageDialog(this,"Se ha eliminado el usuario.", "", JOptionPane.INFORMATION_MESSAGE);
            }catch (SQLException e) {
            JOptionPane.showMessageDialog(this,"no Se ha eliminado el usuario.", "", JOptionPane.WARNING_MESSAGE);
            }
            this.dispose();
    } 
